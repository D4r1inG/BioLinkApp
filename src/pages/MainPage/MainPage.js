        ...
        return (
          ...
          >
            ...
            <div className="mt-4 leading-17 text-black font-inter font-medium">
              <p className="text-xl m-0 mr-2">{item?.name}</p>
              <svg
                width="16"
                height="16"
                viewBox="0 0 16 16"
  ...
  return (
    <div id="main_page">
      <div
        className={`${
          !isAnimate ? "" : "bg_dark"
        } pt-24 bg_landing overflow-hidden`}
      >
        <div
          ref={header}
        ...
        >
          <div className="mx-8">
            <div
              ...
              className={`${
                !isAnimate ? "" : "bg_dark"
              } flex relative mx-auto py-4 px-5 shadow-xl width_1300 bg_landing`}
            >
              <div>
              ...
              <div
                className={`${
                  !isAnimate ? "text-black " : "text-white "
                } font-inter header_btn font-semibold mr-6 cursor-pointer self-center duration-200 hover:text-gray-600`}
              >
                Features
              </div>
              <div
                className={`${
                  !isAnimate ? "text-black" : " text-white"
                } font-inter header_btn font-semibold cursor-pointer self-center duration-200 hover:text-gray-600`}
              >
                FAQ
              </div>
              <div className="flex flex-grow flex-row-reverse">
                {/* <NavLink
                  to="/listuser"
                  className={`${
                    !isAnimate ? "bg-black text-white" : "bg-white text-black"
                  } ml-2 font-inter sign_up_btn font-medium text-base cursor-pointer rounded-full py-2 px-6 dashboard_tour`}
                >
                  List profiles
                </NavLink> */}
                    ...
                    <NavLink
                      ...
                      className={`${
                        !isAnimate
                          ? "bg-black text-white"
                          : "bg-white text-black"
                      } font-inter sign_up_btn font-medium text-base cursor-pointer rounded-full py-2 px-6 `}
                    >
                      Sign up
                    </NavLink>
                    <NavLink
                      ...
                      className={`${
                        !isAnimate ? "text-black" : "text-white"
                      } font-inter header_btn font-semibold mr-8 cursor-pointer text-base self-center`}
                    >
                      Log in
                    </NavLink>
                  </>
                    ...
                    <NavLink
                      ...
                      className={`${
                        !isAnimate
                          ? "bg-black text-white"
                          : "bg-white text-black"
                      } font-inter sign_up_btn font-medium text-base cursor-pointer rounded-full py-2 px-6 dashboard_tour`}
                    >
                      DashBoard
                    </NavLink>
                    <div
                      ...
                      className={`${
                        !isAnimate ? "text-black" : "text-white"
                      } font-inter header_btn font-semibold ml-3 px-3 cursor-pointer text-base self-center`}
                    >
                      Log out
                    </div>
                  </>
        ...
        <div
          ...
          className={`duration-700  ${
            !isAnimate ? "opacity-100" : "opacity-25"
          }`}
        >
        ...
        <div
          id="myStat"
          className={`grid grid-cols-2 gap-y-8 w-screen w-1100 mx-auto lg:flex lg:space-x-12 lg:justify-center mt-16 mb-24 duration-700 ${
            !isAnimate ? "opacity-100" : "opacity-25"
          }`}
        >
          <div className="flex ">
        ...
        <div
          className={`dark-space ${
            !isAnimate ? "" : "dark-space-in"
          } mx-auto p-0`}
        >
          <div className="width_1300 mx-auto dark-space-black py-16 bg-black rounded-xl">
            <div className="font-semibold py-2 text-4xl text-gradient text-center">
              Launch your page in seconds
            </div>
            <div className="flex flex-col justify-center content-center lg:grid lg:grid-cols-3 lg:gap-8 lg:mx-20 mt-12 font-semibold">
              <div className="mx-5 lg:mx-0">
                ...
                <div className="w-350p md:px-0 lg:w-auto leading-relaxed xl:w-350p mx-auto text-white text-xl sm:text-24 mt-6">
                  <h2>Claim your bio link</h2>
                  <h3 className="text-whiteLOp font-inter font-medium">
              ...
              <div className="mx-5 lg:mx-0 lg:mt-0">
                ...
                <div className="w-350p md:px-0 lg:w-auto leading-relaxed xl:w-350p mx-auto text-white text-xl sm:text-24 mt-6">
                  ...
                  <h3 className="text-whiteLOp font-inter font-medium">
                    Add your socials, websites, videos, anything. Your bio link
                    is your new website.{" "}
                  </h3>
                </div>
              </div>
              <div className="mx-5 lg:mx-0 lg:mt-0">
                ...
                <div className="w-350p md:px-0 lg:w-auto leading-relaxed xl:w-350 mx-auto text-white text-xl sm:text-24 mt-6">
                  <h2>Use it everywhere</h2>
                  <h3 className="text-whiteLOp font-inter font-medium">
                    Use your bio link on your Instagram, Twitter, TikTok,
                    emails, wherever people follow you.
                  </h3>
                </div>
              </div>
            </div>
        ...
        <div className="flex flex-col justify-center align-center mt-90 mt-24 w-full w-1100 mx-auto">
          <h3
            id="profiles"
            className={`${
              !isAnimate ? "opacity-100" : "text-gray-600 opacity-25"
            } text-5xl xl:px-0 text-black  leading-relaxed self-center font-bold duration-700 `}
          >
            Loved by thousands{" "}
            <span
              className={`text_gray  ${!isAnimate ? "text_gray_light" : ""} `}
            >
              {" "}
          ...
          <div className="mx-auto mb-4 mt-24 w-full w-1100 ">
            ...
            <div className="my-12 flex flex-row gap-0 justify-between">
              <div className="flex flex-col text-left">
                ...
                <div className="flex lg:justify-end gap-8 text-base font-inter font-medium text-dark mt-8 text-black">
              ...
              <div className="flex flex-col">
                ...
                <div className="font-inter font-medium mt-8 text-right text-black">
                  ...
                  <a
                    href="https://www.facebook.com/profile.php?id=100005135208157"
