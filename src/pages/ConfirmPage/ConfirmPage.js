        ...
        <>
            <div className='flex items-center justify-center flex-col h-screen'>
                <div className='p-12 bg-green-50 rounded-sm'>
                    ...
                    <NavLink to={'/login'} >
                        <button className="bl-btn bl-bg px-12 font-semibold font-inter bg-gray-300 text-white rounded-md leading-4 relative flex justify-center items-center mt-6 w-full uppercase tracking-wider" style={{ height: '40px' }}>
                            <span>Login</span>
                        </button>
                    </NavLink>
                </div>
