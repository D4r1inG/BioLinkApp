...
export default function ListUserPage() {
    ...
    const renderCard = (list) => {
        return list.filter((item, index) => index !== 0).map((item, index) => {
            return <CardDefault item={item} key={index} />
        })
    }

    return (
        <div id='list-user' className='bg-gray-50 '>
            <div className='border-b-2 border-gray-100 w-full z-40'>
                <div className='bg-white flex justify-center items-center px-16' style={{ height: "60px" }}>
