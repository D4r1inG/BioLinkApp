            ...
            <div className='fixed top-0 left-0 border-b-2 border-gray-100 w-full z-40'>
                <div className='bg-white flex justify-between items-center px-16' style={{ height: "60px" }}>
                    ...
                    <div className='flex items-center'>
                        ...
                        <NavLink className='text-sm underline text-blue-500 ml-1' to='/signup' >Sign up</NavLink>
                    </div>
                </div>
            </div>
            <div className='mt-16  h-full' style={{ width: '400px' }}>
                <div className='bg-white p-8 rounded-md'>
                    <div className="flex w-full">
                        <div className=" font-bold text-xl w-full">Login</div>
                    </div>
                    <div className='mt-6'>
                    ...
                    <div className="relative bl-input-with-suffix-wrap mt-4">
                        ...
                        <div className="text-center">
                            <a href="#" className="mt-3 text-blue-400 text-sm font-inter font-normal inline-block">
                                Forgot password?
                            </a>
                        </div>
                    </div>
                    ...
                    <a href="#">
                        <button className="font-semibold text-sm relative flex justify-center items-center mt-4 btn-signup-social text-black rounded-md w-full h-10">
                            <span className="flex">
                                ...
                                <span className="w-155 text-left">Continue with Facebook</span>
                            </span>
