...
// import {
//   getLinkDataFirstTime,
//   getSocialList,
// } from "../../redux/Actions/LinkAction";
...
export default function PhoneView() {
  ...
  const { userProfile, isCreating, newTheme, themes } = useSelector(
  ...
  const renderSocialList = (list) => {
    return list.map((item, index) => {
      return (
        <div key={index} className="page-social relative mx-3 mb-3">
          <a
        ...
        if (item.isHeader) {
          return (
            <div
              ...
              className="transition-all text-center font-bold text-base mt-9 limit-one-line break-all overflow-hidden"
            >
              {item.title}
            </div>
          );
          ...
          return (
            ...
            >
              <div
                style={pageItem}
                className="flex justify-center items-center pill-item transition-all"
              ></div>
              <div
              ...
              >
                {renderImg(item)}
                <span
                  className="item-title limit-one-line break-all overflow-hidden pl-3 pr-12 flex-1 text-center transition-all"
                  style={{
          ...
          return (
            ...
            >
              ...
              >
                {renderImg(item)}
                <span
                  className="item-title text-center limit-one-line break-all overflow-hidden px-4 transition-all"
                  style={{
                    color: theme?.colorLink,
                    fontFamily: theme?.fontFamily,
                  }}
      ...
      <div className=" w-full min-h-full flex justify-center relative">
        ...
        <div style={{ width: "90%" }} className="mt-12 pb-32">
          ...
          <h2
            ...
            className="font-semibold mt-4 text-center transition-all"
          >
            {name}
          </h2>
          <div
            className="text-base font-normal mt-3 text-center transition-all"
          ...
          <div className="mt-6">{renderLink(linkList)}</div>
