    ...
    <div>
      ...
      <div className="flex flex-wrap">
        {socialList.map((item, index) => {
          return <div key={index} className="mr-3 mb-3 socio sociallink-each flex justify-center items-center bg-white hover:shadow-sm transform hover:scale-105 duration-50 rounded-full w-h-48 cursor-pointer last:mr-0">
            <span>
