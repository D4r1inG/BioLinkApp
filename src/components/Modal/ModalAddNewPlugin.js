...
const spotifyURLRegex = /(https?:\/\/open.spotify.com\/(track|user|artist|album)\/[a-zA-Z0-9]+(\/playlist\/[a-zA-Z0-9]+|)|spotify:(track|user|artist|album):[a-zA-Z0-9]+(:playlist:[a-zA-Z0-9]+|))/
        ...
        <div>
            <div className='flex mt-8 w-full justify-between'>
                ...
                <div className='ml-6 flex-shrink-0 relative'>
                    <img className='link-thumb-img-upload' alt={modalHeader} src={imgSrc} />
                </div>
            </div>
