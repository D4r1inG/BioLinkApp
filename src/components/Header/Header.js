...
export default function Header() {
    return (
        <div className='fixed border-b-2 border-gray-100 w-full z-50'>
            <div className='bg-white flex justify-between items-center px-16' style={{ height: "60px" }}>
                ...
                <div className='flex gap-4 items-center'>
                    <a className='underline font-inter text-base text-blue-400 cursor-pointer'>bio.link/qunnguyn21</a>
                    <div>
