  ...
  const renderBgColor = () => {
    return (
      <div className="grid grid-cols-6 items-center">
        <div
          className={`rounded-full relative overflow-hidden flex justify-center items-center br-gray custom-color-picker cursor-pointer ${
            newTheme.background === true ? "theme-select-border" : ""
          }`}
        ...
        {bgColorOptions.map((item, index) => {
          return (
            ...
            >
              <div
                className="bl-color-each rounded-full br-grey relative"
                style={{ backgroundColor: item, width: "64px", height: "64px" }}
              ></div>
            </div>
          );
        })}
        ...
        <div className="pt-2 grid grid-cols-6 items-center">
          ...
          >
            ...
            <input
              ...
              name="color1"
              className="absolute w-full h-full top-0 left-0 opacity-0 cursor-pointer"
              onChange={handleChangeBgGradiantColor}
            />
          </div>
          {bgColorOptions.map((item, index) => {
            return (
      ...
      return (
        <div
          ...
          className={`flex justify-center items-center ${
            newTheme.btnRadius === item
              ? "theme-select-border"
              : "theme-default-border"
          }`}
          style={{ borderRadius: item, height: "56px", padding: "0 2px 0" }}
          onClick={() => {
            dispatch({
              type: "UPDATE_NEW_THEME",
              btnRadius: item,
        ...
        >
          <div
            className="cursor-pointer relative overflow-hidden w-full theme-bordered-btn"
            style={{ borderRadius: item, height: "48px" }}
          ></div>
        </div>
      );
    });
    ...
    return btnBdStyles.map((item, index) => {
      return (
        <div
          key={index}
          className={`flex justify-center items-center ${
            newTheme.btnBdStyle === item
              ? "theme-select-border"
              : "theme-default-border"
          }`}
          style={{ height: "56px", padding: "0 2px 0" }}
          onClick={() => {
            dispatch({
              type: "UPDATE_NEW_THEME",
              btnBdStyle: item,
        ...
        >
          <div
            className="cursor-pointer relative overflow-hidden w-full theme-bordered-btn"
            style={{ borderStyle: item, height: "48px" }}
          ></div>
        </div>
      );
    });
  ...
  const renderFont = () => {
    return fontOptions.map((item, index) => {
      return (
        <div
          key={index}
          className={`rounded-md  cursor-pointer rounded-12 flex justify-center items-center mb-6 ${
            newTheme.fontFamily === item.fontFamily
              ? "theme-select-border"
              : "theme-default-border"
          }`}
          style={{ height: "56px", padding: "0 2px 0" }}
        ...
        >
          <div
            className="rounded-md flex justify-center items-center overflow-hidden relative br-grey w-full"
            style={{ height: "48px" }}
          >
            <div
  ...
  return (
    <div className="p-8 bg-white rounded-sm mt-8 shadow-sm">
      <div className="text-2xl font-bold text-black mb-10 text-center">
        ...
        <div className="input-main-wrap overflow-hidden	rounded-sm mb-4 flex">
          <input
            ...
            name="name"
            placeholder="Name"
            className="flex-1 bl-input w-full p-4 text-sm font-normal font-inter placeholder-grey hover:bg-bl-bg-grey focus:bg-white"
          />
        </div>
      </div>
      ...
      <div className="pb-8 border-b-gray-200 border-b mt-6">
        <div className="w-full">
          <div className="grid grid-cols-3 gap-x-8">
            ...
            <div
              className={`p-1 rounded-xl border border-black  ${
                bgGradiant ? "theme-select-border" : ""
              }`}
              onClick={() => {
                setBgGradiant(true);
                setBgImg(false);
            ...
            >
              <div className="theme-btn-box rounded-md flex justify-center items-center flex-col relative cursor-pointer">
                ...
                <div className="font-inter text-black font-semibold text-sm mt-2 text-center px-6 ">
                  Gradiant
                </div>
              </div>
            </div>
            ...
            <label
              htmlFor="imgBg"
              className={`p-1 rounded-xl ${
                bgImg ? "theme-select-border" : "theme-default-border"
              }`}
            >
              <div className="theme-btn-box theme-gradient-btn rounded-md flex justify-center items-center flex-col relative cursor-pointer">
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    dispatch({
                      type: "UPDATE_NEW_THEME",
                      backgroundImg: window.URL.createObjectURL(
      ...
      <div className="mt-12 pb-8 border-b-gray-200 border-b">
        ...
        <div className="font-inter font-semibold text-black text-lg text-center">
          {" "}
          Border radius
        </div>
      ...
      <div className="mt-12">
        ...
        <div className="pb-8 mt-3">
          <div className="pt-3 grid grid-cols-3 gap-x-4">{renderFont()}</div>
        </div>
      </div>
