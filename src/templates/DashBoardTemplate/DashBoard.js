  ...
  return (
    <>
      <div
        ...
        style={{ backgroundColor: "rgba(0,0,0,.025)", minHeight: "100vh" }}
      >
        <Header />
        <div className="flex " style={{ paddingTop: "60px" }}>
          <div
            className="fixed h-screen left-0 py-8 z-10 bg-white"
            style={{ width: "40vw" }}
          >
          ...
          <div
            className="pt-8 pr-40 pb-24 w-full flex"
            style={{ paddingLeft: "calc(40vw + 16px)" }}
          >
            <div>
              <Navigation {...route} />
            </div>
